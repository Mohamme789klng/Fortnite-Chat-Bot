...
swears=['shit','crap','fuck','twat','prick']
...
while True:
  ...
  if 'who' in question and 'you' in question and('made'  in question or 'created' in question or 'designed' in question or 'coded' in question or 'dad' in question or 'mum' in question or 'parent' in question):
    print("The python coder 'thomasf04' created me. Please upvote this if you liked it.")
  ...
  if 'revolver' in question:
    print("Please don't use the 'r' word. Thank you!" )
  ...
  if 'what' in question:
    print("If something I said doesn't look quite right, be sure to tell me in the comments!")
  if 'why' in question:
